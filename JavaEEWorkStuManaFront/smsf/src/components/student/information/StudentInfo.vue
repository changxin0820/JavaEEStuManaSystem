<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>查看我的个人信息</el-breadcrumb-item>
    </el-breadcrumb>
    <el-container style=" height: 500px; width:100% ;border: 1px solid #efe0b0; border-radius: 12px">
      ...
      <el-footer>
        <div style="text-align:left; font-size: 15px;color:#000000; border: 1px dotted #fa7b7b; padding: 10px">
          <span><b>备注:</b> 学生若发现信息与个人不符，请到所在学院教学秘书处申请修改。</span>
        </div>
      </el-footer>
    </el-container>
  </div>
